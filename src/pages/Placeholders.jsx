...
import { Settings, CreditCard, TrendingDown, PieChart, Users, TrendingUp } from 'lucide-react'
    ...
    <div>
      ...
      <div className="card" style={{ padding:0,overflow:'hidden' }}>
        {[
          ...
          <Link key={to} to={to} style={{ display:'flex',alignItems:'center',gap:'1rem',textDecoration:'none',color:'#1F2937',padding:'1rem 1.25rem',borderTop:i>0?'1px solid #F3F4F6':'none' }}>
